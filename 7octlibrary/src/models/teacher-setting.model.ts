...
@model()
export class TeacherSetting extends Entity {
  @property({
    type: 'string',
    id: true,
    generated: true,
  ...
  constructor(data?: Partial<TeacherSetting>) {
    super(data);
  }
}

export interface TeacherSettingRelations {
  // describe navigational properties here
}

export type TeacherSettingWithRelations = TeacherSetting &
