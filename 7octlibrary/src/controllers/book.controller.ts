...
export class BookController {
  ...
  async find(
    ...
    var data = this.bookRepository.find({include: ['author', 'publisher', 'genre', 'edClass', 'language', 'bookCategory', 'subject']});
    // console.log("77 =" + data);
  ...
  async findById(
    ...
    return this.bookRepository.findById(id, {include: ['author', 'publisher', 'genre', 'edClass', 'language', 'bookCategory', 'subject', 'bookItems']});
  }
